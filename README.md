...
This repository contains a hardened, honest workshop-only robotics paper draft for `hierarchical_failure_containment`.
...
Canonical local PDF path: `C:/Users/wangz/Downloads/105.pdf`
