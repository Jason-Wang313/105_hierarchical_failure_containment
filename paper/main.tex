...
\usepackage{url}
\usepackage{booktabs}
\title{Hierarchical Failure Containment: ICLR Main-Conference Gate Archive}
...
\begin{itemize}
\item H-WM: Robotic Task and Motion Planning Guided by Hierarchical World Model (2026)
\item Grounding Large Language Models for Robot Task Planning Using Closed-Loop State Feedback (2025)
\item Hierarchical Vision-Language Planning for Multi-Step Humanoid Manipulation (2025)
\item Hierarchical Vision Language Action Model Using Success and Failure Demonstrations (2025)
\item FailSafe: Reasoning and Recovery from Failures in Vision-Language-Action Models (2025)
\end{itemize}
